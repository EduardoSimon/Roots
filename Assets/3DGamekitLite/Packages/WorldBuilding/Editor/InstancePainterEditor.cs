...
namespace Gamekit3D.WorldBuilding
{
    ...
    public partial class InstancePainterEditor : UnityEditor.Editor
    {
        ...
        UnityEditor.Editor variationsEditor;
        ...
        void OnEnable()
        {
            ...
            if (ip.SelectedPrefab != null)
            {
                ...
                if (variations != null)
                    variationsEditor = UnityEditor.Editor.CreateEditor(variations);
                CreateNewStamp();
            }
