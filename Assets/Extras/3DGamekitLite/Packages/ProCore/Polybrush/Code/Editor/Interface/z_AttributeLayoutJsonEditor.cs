...
namespace Polybrush
{
	...
	public class z_AttributeLayoutJsonEditor : UnityEditor.Editor
	{
		[SerializeField] z_AttributeLayoutContainer container = null;
		[SerializeField] UnityEditor.Editor editor = null;
		...
		public override void OnInspectorGUI()
		{
			...
			if(editor == null)
			{
				...
				editor = UnityEditor.Editor.CreateEditor(container);
			}
